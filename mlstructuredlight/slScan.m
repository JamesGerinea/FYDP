...
% for i = 1:11
%   % Display and capture current Gray code stripe pattern.
%   Screen('CopyWindow',I{1,i},window,rect,rect);
%     Screen('Flip',window); pause(frameDelay);
%   A{1,i} = camCapture(camera);
%   Screen('CopyWindow',J{1,i},window,rect,rect);
%     Screen('Flip',window); pause(frameDelay);
%   B{1,i} = camCapture(camera);
% end
% for i = 1:10
%   % Display and capture current Gray code stripe pattern.
%   Screen('CopyWindow',I{2,i},window,rect,rect);
%     Screen('Flip',window); pause(frameDelay);
%   A{2,i} = camCapture(camera);
%   Screen('CopyWindow',J{2,i},window,rect,rect);
%     Screen('Flip',window); pause(frameDelay);
%   B{2,i} = camCapture(camera);
% end
